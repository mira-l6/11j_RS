    ...
    <div class="add-task-box">
      ...
      <form action="add-task.php" method="post">
        ...
        <div class="date">
          ...
          <input id="start-date" type="string" class="form-control" pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-mm-dd">
        </div>
        <div class="date">
          <label for="due-date" class="form-control">Краен срок (YYYY-MM-DD)</label>
          <input id="due-date" type="string" class="form-control" pattern="\d{4}-\d{2}-\d{2}" placeholder="YYYY-mm-dd">
        </div>
